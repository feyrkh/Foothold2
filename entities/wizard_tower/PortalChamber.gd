...
func get_description()->String:
	match tutorial_goal_state:
		...
		PortalTutorialGoal.GOAL_DEBRIS_CLEARED: return "With the debris piled neatly in one corner, nearly to the ceiling, it's now possible to reach the stone arch carved into the wall."
